        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2"> 
                <form class="mx-4" method="post" action="{{route('admin-berita-abpadmin-tambah')}}" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-12 text-end pb-4">
                        <button class="btn bg-gradient-primary mb-0" href="{{route('admin-berita-abpadmin')}}">Simpan</button>
                        <a class="btn bg-gradient-primary mb-0" href="{{route('admin-berita-abpadmin')}}">Batal</a>
                    </div>
                </form>
            </div>
          </div>
